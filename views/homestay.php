...
<body class="blog-page">
  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade"
      style="background-image: url(/public_html/assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        <h1>Homestay Nepal van Java</h1>
        <p>Pilih penginapan terbaik dengan suasana lokal yang nyaman dan hangat.</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="/public_html/assets/img/blog/blog-1.jpg" class="img-fluid" alt="">
              </div>

              <div class="meta d-flex align-items-end">
                <span class="post-date"><span>Rp</span>150000</span>
                <div class="d-flex align-items-center">
                  <i class="bi bi-house-door"></i> <span class="ps-2">2 Kamar, WiFi</span>
                </div>
                <span class="px-3 text-black-50">/</span>
                <div class="d-flex align-items-center">
                  <i class="bi bi-geo-alt"></i> <span class="ps-2">Dekat Sunrise Point</span>
                </div>
              </div>

              <div class="post-content d-flex flex-column">
                <h3 class="post-title">Homestay Mawar</h3>
                <a href="blog-details.php" class="readmore stretched-link"><span>Lihat Detail</span><i
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="/public_html/assets/img/blog/blog-2.jpg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="/public_html/assets/img/blog/blog-3.jpg" class="img-fluid" alt="">
              </div>
              <div class="meta d-flex align-items-end">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="/public_html/assets/img/blog/blog-4.jpg" class="img-fluid" alt="">
              </div>
              <div class="meta d-flex align-items-end">
          ...
          <div class="col-lg-4">
            <article class="position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="/public_html/assets/img/blog/blog-5.jpg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-4">/public_html/
            <article class="position-relative h-100">

              <div class="post-img position-relative overflow-hidden">
                <img src="/public_html/assets/img/blog/blog-6.jpg" class="img-fluid" alt="">
              </div>
